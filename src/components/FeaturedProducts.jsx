      ...
      <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
        <div>
          <h2 
            ...
            data-speed="0.8"
          >
            Featured <span className="text-red-500">Productts</span>
          </h2>
          <p 
            ref={subtextRef}
        ...
        {PRODUCTS.map((product) => (
          ...
          >
            ...
            <div className="flex items-baseline gap-2">
              ...
              {/* السعر القديم متشخبط عليه - باهت ومصمم بـ font-mono */}
              {product.oldPrice && (
                <span className="text-white/40 font-mono text-sm line-through tracking-wide">
                  {product.oldPrice}
                </span>
              )}
            </div>
            ...
            <button className="relative overflow-hidden group/btn text-white text-[10px] font-black tracking-tighter border border-white/10 px-4 py-2 cursor-pointer">
